    ...
    <div>
      ...
      <div className="section-separator" />{" "}
        ...
        <p className="information-p">
          1 day when he was talking to himself and wondering what he would like
          to do in the future he got the idea to work as a software developer,
          he started searching for jobs and found out that a skill that was very
          high in demand was{" "}
          <a
